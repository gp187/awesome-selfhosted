...
- [Naologic](https://naologic.com/) - AI-powered ERP CRM with a no-code editor included to help you manage sales, purchasing, inventory, learning, manufacturing ... Automatic deployment to your own cloud([Demo](https://naologic.com)) `GPL-3.0`
